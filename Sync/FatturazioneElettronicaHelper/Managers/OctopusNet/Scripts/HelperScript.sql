...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_AN_FatturazioneElettronicaHelper_AN_Anagrafiche]') AND parent_object_id = OBJECT_ID(N'[dbo].[AN_FatturazioneElettronicaHelper]'))
ALTER TABLE [dbo].[AN_FatturazioneElettronicaHelper]  WITH CHECK ADD  CONSTRAINT [FK_AN_FatturazioneElettronicaHelper_AN_Anagrafiche] FOREIGN KEY([FKeyAnagrafica])
REFERENCES [dbo].[AN_Anagrafiche] ([ID_Anagrafica])

IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_AN_FatturazioneElettronicaHelper_AN_Anagrafiche]') AND parent_object_id = OBJECT_ID(N'[dbo].[AN_FatturazioneElettronicaHelper]'))
ALTER TABLE [dbo].[AN_FatturazioneElettronicaHelper] CHECK CONSTRAINT [FK_AN_FatturazioneElettronicaHelper_AN_Anagrafiche]
...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_FE_StatiFattureElettroniche_RI_RicevuteFiscali]') AND parent_object_id = OBJECT_ID(N'[dbo].[FE_StatiFattureElettroniche]'))
ALTER TABLE [dbo].[FE_StatiFattureElettroniche]  WITH CHECK ADD  CONSTRAINT [FK_FE_StatiFattureElettroniche_RI_RicevuteFiscali] FOREIGN KEY([FKeyFattura])
REFERENCES [dbo].[RI_RicevuteFiscali] ([ID_Ricevuta])


IF  EXISTS (SELECT * FROM sys.foreign_keys WHERE object_id = OBJECT_ID(N'[dbo].[FK_FE_StatiFattureElettroniche_RI_RicevuteFiscali]') AND parent_object_id = OBJECT_ID(N'[dbo].[FE_StatiFattureElettroniche]'))
ALTER TABLE [dbo].[FE_StatiFattureElettroniche] CHECK CONSTRAINT [FK_FE_StatiFattureElettroniche_RI_RicevuteFiscali]
